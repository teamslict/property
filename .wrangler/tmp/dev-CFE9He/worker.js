...
// .wrangler/tmp/bundle-34SyhL/checked-fetch.js
...
async function serveStaticFile(path, env) {
  try {
    ...
    return jsonResponse({ error: "Failed to serve file" }, 500);
  }
}
        ...
        if (path === "/api/properties") {
          if (request.method === "POST") {
            ...
            try {
              ...
              return jsonResponse({ error: "Failed to save property" }, 500);
            }
          }
...
// .wrangler/tmp/bundle-34SyhL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-34SyhL/middleware-loader.entry.ts
